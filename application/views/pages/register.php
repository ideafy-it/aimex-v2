<div class="container">
    <h2>Register Page</h2>
        <form action="<?php echo base_url(); ?>pages/register_validation" method="post" data-parsley-validate>
        <div class="form-group">
            ...
            <span class="text-danger"><?php echo form_error('employee_firstname'); ?></span>
        </div>
        <div class="form-group">
            ...
            <span class="text-danger"><?php echo form_error('employee_lastname'); ?></span>
        </div>
        <div class="form-group">
            ...
            <span class="text-danger"><?php echo form_error('employee_username'); ?></span>
        </div>
        <div class="form-group">
            ...
            <span class="text-danger"><?php echo form_error('employee_password'); ?></span>
        </div>
        <div class="form-group">
