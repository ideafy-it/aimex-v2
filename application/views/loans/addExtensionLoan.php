...
<br>
<div class="card">
    <h5 class="card-header">Extension Loan</h5>
    <div class="card-body">
            ...
            <div class="row col-12">
                <div class="col-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="remainingMonths" id="RemainingMonths" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="MonthsToAvail">Months To Avail</label>
                        <input type="number" name="monthsToAvail" id="MonthsToAvail" class="form-control">
                    </div>
                </div>
                <div class="col-6">
                <div class="form-group">
